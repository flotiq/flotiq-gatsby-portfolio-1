...
5. **Open the source code and start editing!**
   ...
   Open the `flotiq-gatsby-portfolio-1` directory in your code editor of choice and edit `src/templates/index.js`. Save your changes and the browser will update in real time!
